...
//    }
    ...
    private void demande(MouseEvent event) {
        try {
                ...
                Logger.getLogger(Demande1Controller.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
    ...
    private void reclamation(MouseEvent event) {
          try {
                ...
                Logger.getLogger(Reclamation1Controller.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
