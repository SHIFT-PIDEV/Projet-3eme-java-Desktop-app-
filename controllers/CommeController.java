 ...
 * @author mahdi
 */
public class CommeController implements Initializable {
    ...
    private Text commentaire;
     ...
     private commentairecour co;
    private Client client;
     public void setDataComm(commentairecour c) {
        this.co = c;
        commentairecservice es= commentairecservice.getCommentairecservice();
