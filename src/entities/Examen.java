...
public class Examen {
    ...
    public Examen( String titreE, LocalDate date, String niveau, int prixE) {
    ...
    public Examen(int idE, String titreE, LocalDate date, String niveau, int prixE) {
        this.idE = idE;
        this.titreE = titreE;
        this.date = date;
        this.niveau = niveau;
    ...
    public Examen(String titreE, LocalDate date, String niveau, int prixE, String support) {
        this.titreE = titreE;
        this.date = date;
        this.niveau = niveau;
        this.prixE = prixE;
    ...
    public Examen(int idE, String titreE, LocalDate date, String niveau, int prixE, String support) {
        this.idE = idE;
        this.titreE = titreE;
        this.date = date;
        this.niveau = niveau;
