...
//                       try {
//                Parent page2 = FXMLLoader.load(getClass().getResource("/views/examenview.fxml"));
...
//                Logger.getLogger(Add_examenController.class.getName()).log(Level.SEVERE, null, ex);
//            }
    ...
    private void ajouterExamen(ActionEvent event) {
                 ...
                 if(tf_support.getText().isEmpty())
       {
        ...
        else 
        {
            ...
            ExamenService exSer = ExamenService.getInstance();
            exSer.insert(exam);
//            tf_control_saisie.setText("bravoooo");
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Information Dialog");
            alert.setHeaderText(null);
            alert.setContentText("examen insérée avec succés! Bravo");
            alert.show();
...
//            try {
//                Parent page2 = FXMLLoader.load(getClass().getResource("/views/add_examen.fxml"));
//                Scene scene = new Scene(page2);
//                Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
//                stage.setScene(scene);
//                stage.show();
